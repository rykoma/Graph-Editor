    ...
    public sealed partial class MainEditorContainer : Page
    {
        ...
        private readonly Dictionary<string, Func<string>> SampleQueryFunctions = new Dictionary<string, Func<string>>()
        {
            ...
            },
            {
                "${DateTime0DayLater9}", () =>
                {
                    return DateTime.Now.ToString("yyyy-MM-dd") + "T09:00:00";
                }
            },
            {
                "${DateTime0DayLater18}", () =>
            ...
            },
            {
                "${DateTime1DayLater8}", () =>
                {
                    return DateTime.Now.AddDays(1).ToString("yyyy-MM-dd") + "T08:00:00";
                }
            },
            {
                "${DateTime1DayLater9}", () =>
            ...
            {
                "${DateTime1DayLater235959}", () =>
                {
                    return DateTime.Now.AddDays(1).ToString("yyyy-MM-dd") + "T23:59:59";
                }
            },
            {
                "${DateTime2DayLater0}", () =>
            ...
            {
                "${DateTime1DayLater235959Utc}", () =>
                {
                    return DateTime.Now.AddDays(1).ToString("yyyy-MM-dd") + "T23:59:59";
                }
            },
            {
                "${DateTime7DayLater0Utc}", () =>
                {
                    return DateTime.Now.AddDays(7).ToString("yyyy-MM-dd") + "T00:00:00Z";
                }
            },
            {
